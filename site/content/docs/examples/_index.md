...
`examples/ci-pipelines/` is a worked example with no page here yet: the CI a
...
guard that regenerating leaves the tree clean. Its own
[README](https://github.com/INTENTIUS/choudoufu/blob/main/examples/ci-pipelines/README.md)
is the walkthrough until the page arrives.
