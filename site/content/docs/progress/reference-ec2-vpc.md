...
|---|---|---|---|
| Cold deploy | pass | 1m37s | 5 resources from plain terraform, a real terraform.tfstate, zero markers |
| Migrate | pass | 1m0s | 5 of 5 verified, 5 stamped, 0 skipped |
| Replan from nothing | pass | 4s | post-adoption plan is empty; markers read back through the AWS CLI in part A |
| No-op apply | pass | 9s | no-op apply (0 added, 0 changed, 0 destroyed); tofu-estate-tagged object count unchanged at 5 |
| Drift and reconverge | pass | 11s | one object tampered, exactly aws_instance.main proposed, apply changed 1 and the tag reads back as configured |
