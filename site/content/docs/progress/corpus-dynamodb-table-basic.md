...
| Drift and reconverge | pass | one object tampered (arn:aws:dynamodb:eu-west-1:000000000000:table/my-table-honest-fish's Terraform tag), plan proposed fixing exactly one object, apply changed 1 and reconverged the tag |
...
Last run at commit `d79be166bd` on 2026-08-22T23:48:05Z, exit code 0.
