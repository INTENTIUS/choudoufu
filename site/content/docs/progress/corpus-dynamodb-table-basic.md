...
| Drift and reconverge | pass | one object tampered (arn:aws:dynamodb:eu-west-1:000000000000:table/my-table-capital-mustang's Terraform tag), plan proposed fixing exactly one object, apply changed 1 and reconverged the tag |
...
Last run at commit `a6eee94de4` on 2026-08-25T12:19:38Z, exit code 0.
