...
| Drift and reconverge | pass | one object tampered (arn:aws:dynamodb:eu-west-1:000000000000:table/my-table-chief-wasp's Terraform tag), plan proposed fixing exactly one object, apply changed 1 and reconverged the tag |
...
Last run at commit `bac351a3d8` on 2026-08-22T04:10:01Z, exit code 0.
