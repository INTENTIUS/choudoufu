...
| Drift and reconverge | pass | one object tampered (arn:aws:dynamodb:eu-west-1:000000000000:table/my-table-loved-crab's Terraform tag), plan proposed fixing exactly one object, apply changed 1 and reconverged the tag |
...
Last run at commit `51b30d36ca` on 2026-08-25T05:28:18Z, exit code 1.
