...
| Drift and reconverge | pass | one object tampered (arn:aws:dynamodb:eu-west-1:000000000000:table/my-table-measured-bullfrog's Terraform tag), plan proposed fixing exactly one object, apply changed 1 and reconverged the tag |
...
Last run at commit `76d00df31f` on 2026-08-25T03:10:34Z, exit code 0.
