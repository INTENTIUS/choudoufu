...
| Replan from nothing | FAIL | the plan's prior state for the ECS cluster is "", not the live cluster ARN "arn:aws:ecs:eu-west-1:000000000000:cluster/ex-fargate" - the projection bound something else, or nothing |
| No-op apply | not run |  |
...
Last run at commit `eadb0741b7` on 2026-08-23T04:04:11Z, exit code 1.
