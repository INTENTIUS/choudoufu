...
| Migrate | pass | 55s | 7 stamped, 7 distinct hosted zones, one per module call |
| Replan from nothing | pass | 10s | no resource change proposed, nothing foreign; all 35 rendered identities name a live hosted zone or record set |
