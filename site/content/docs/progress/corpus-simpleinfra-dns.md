...
|---|---|---|---|
| Cold deploy | pass | 1m18s | 35 instances (7 zones, 28 records) from plain terraform, 0 of 7 zones carry tofu-estate |
| Migrate | pass | 42s | 7 stamped, 7 distinct hosted zones, one per module call |
