...
| Migrate | pass | 6 of 30 stamped, 1 recorded (random_pet, issue #340), 23 skipped (untaggable), 0 failed, 26 identities recorded (#364 unit A2); markers survived the residue-classification apply |
| Replan from nothing | pass | no resource action proposed; 29 rendered identity occurrences (11 distinct), all naming known roots |
