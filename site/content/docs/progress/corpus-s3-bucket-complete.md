...
| Migrate | FAIL | the residue-classification apply added or destroyed a resource - it should only ever change |
...
Last run at commit `a5b8d810da` on 2026-08-24T22:15:28Z, exit code 1.
