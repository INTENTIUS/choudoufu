...
| Drift and reconverge | pass | one object tampered (arn:aws:iam::000000000000:policy/example/ex-iam-read-only-policy-27690b21f890397fe7b1b1bb92's Example tag), plan proposed fixing exactly module.read_only_iam_policy.aws_iam_policy.policy[0], apply changed 1 and reconverged the tag |
...
Last run at commit `00acf1c9ba` on 2026-08-24T22:50:09Z, exit code 0.
