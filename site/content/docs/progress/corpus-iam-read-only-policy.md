...
| Migrate | pass | 1m10s | 1 of 1 stamped, carrying tofu-slot=0 read back through IAM (choudoufu #372); Apply complete! Resources: 0 added, 0 changed, 0 destroyed. - nothing left to converge |
...
| Drift and reconverge | pass | 5s | one object tampered (arn:aws:iam::000000000000:policy/example/ex-iam-read-only-policy-81954b7238629b3180311dc878's Example tag), plan proposed fixing exactly module.read_only_iam_policy.aws_iam_policy.policy[0], apply changed 1 and reconverged the tag |
...
Last run at commit `b16763a4db` on 2026-08-29T19:52:47Z, exit code 0, against emulator image `ghcr.io/lex00/floci@sha256:c55d74e13e96c8b132056677337dba0084bb0b427cb039be2dbf9a8b7efc0948`. Total run time 2m53.2s.
