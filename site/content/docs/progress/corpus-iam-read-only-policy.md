...
| Drift and reconverge | pass | one object tampered (arn:aws:iam::000000000000:policy/example/ex-iam-read-only-policy-0e44b89ef86669f5ddbe94d382's Example tag), plan proposed fixing exactly module.read_only_iam_policy.aws_iam_policy.policy[0], apply changed 1 and reconverged the tag |
...
Last run at commit `731a4b8b1e` on 2026-08-23T01:04:07Z, exit code 0.
