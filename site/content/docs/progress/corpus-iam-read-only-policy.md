...
| Drift and reconverge | pass | one object tampered (arn:aws:iam::000000000000:policy/example/ex-iam-read-only-policy-a582861fb234f8cb7bd7f74929's Example tag), plan proposed fixing exactly module.read_only_iam_policy.aws_iam_policy.policy[0], apply changed 1 and reconverged the tag |
...
Last run at commit `8eafcc6a1d` on 2026-08-23T19:28:15Z, exit code 0.
