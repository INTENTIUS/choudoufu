...
| Drift and reconverge | pass | one object tampered (arn:aws:iam::000000000000:policy/example/ex-iam-read-only-policy-bad2c51443c8c05b7bdc5b90b2's Example tag), plan proposed fixing exactly module.read_only_iam_policy.aws_iam_policy.policy[0], apply changed 1 and reconverged the tag |
...
Last run at commit `08cfb71cae` on 2026-08-23T01:36:59Z, exit code 0.
