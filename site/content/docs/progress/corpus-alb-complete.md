...
| Migrate | pass | 47 of 80 stamped, 4 failed on floci#65 |
| Replan from nothing | FAIL | BLOCKED - #309 (choudoufu, markerless-type: 1 aws_cognito_user_pool_client site; condition 3 is CLEARED as of 2026-08-22 - the page's possessive-of import sentence is read and DocumentedImportIDs now composes user_pool_id/id - so credentialMaterial (condition 2, client_secret) is now the SOLE wall, and its breadth for the located path is the open maintainer call; see header); #305's trio is fixed and no longer a stage-3 wall here |
...
Last run at commit `ddc89b89b6` on 2026-08-22T05:38:44Z, exit code 0.
