...
| Replan from nothing | FAIL | BLOCKED - #309 (choudoufu, markerless-type: 1 aws_cognito_user_pool_client site; LocatedType refuses on two independent conditions and the load-bearing one is condition 3, the identity cannot be recorded in full - no wire identity schema at 6.59.0 and no documented import grammar. Narrowing credentialMaterial does not move it; see header); #305's trio is fixed and no longer a stage-3 wall here |
...
Last run at commit `bac351a3d8` on 2026-08-22T04:05:24Z, exit code 0.
