...
10 of 26 estates have a recorded run duration, totaling 39m59s, but not from one sweep: 2m41.8s across 1 estate(s) at commit `0a05c31d8a`; 8m40.1s across 1 estate(s) at commit `29cc0cd1de`; 5m41.9s across 1 estate(s) at commit `5621afcab8`; 3m16.2s across 1 estate(s) at commit `5a591a776f`; 11m55.6s across 4 estate(s) at commit `8ef3d258a7`; 2m55s across 1 estate(s) at commit `aa5c8a0d45`; 4m48.4s across 1 estate(s) at commit `bfa832dbc9`. This total spans different commits, not a single board run, and excludes 16 estate(s) with no recorded duration yet.
...
| [corpus-simpleinfra-dns]({{< relref "corpus-simpleinfra-dns" >}}) | 8m40.1s | cold_deploy 1m11s, migrate 46s, test_plan 8s, test_apply 18s, drift_reconverge 26s, day2_rename 26s, day2_remove 30s, day2_count 1m1s, day2_replace 1m14s, greenfield 2m40s |
