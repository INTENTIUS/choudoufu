...
8 of 26 estates have a recorded run duration, totaling 28m17.1s, but not from one sweep: 2m41.8s across 1 estate(s) at commit `0a05c31d8a`; 3m16.2s across 1 estate(s) at commit `5a591a776f`; 5m21.7s across 1 estate(s) at commit `5c0c2e7fce`; 9m14s across 3 estate(s) at commit `8ef3d258a7`; 2m55s across 1 estate(s) at commit `aa5c8a0d45`; 4m48.4s across 1 estate(s) at commit `bfa832dbc9`. This total spans different commits, not a single board run, and excludes 18 estate(s) with no recorded duration yet.
...
| [corpus-dynamodb-table-basic]({{< relref "corpus-dynamodb-table-basic" >}}) | 5m21.7s | cold_deploy 47s, migrate 1m54s, test_plan 4s, test_apply 5s, drift_reconverge 9s, day2_rename 16s, day2_remove 10s, day2_count 44s, day2_replace 18s, greenfield 53s |
