...
9 of 26 estates have a recorded run duration, totaling 26m21.6s, but not from one sweep: 2m41.8s across 1 estate(s) at commit `0a05c31d8a`; 3m16.2s across 1 estate(s) at commit `5a591a776f`; 2m5.6s across 1 estate(s) at commit `6ad9307677`; 11m55.6s across 4 estate(s) at commit `8ef3d258a7`; 2m55s across 1 estate(s) at commit `aa5c8a0d45`; 3m27.4s across 1 estate(s) at commit `c3a37c0e8e`. This total spans different commits, not a single board run, and excludes 17 estate(s) with no recorded duration yet.
...
| [corpus-leynos-monitoring]({{< relref "corpus-leynos-monitoring" >}}) | 2m5.6s | cold_deploy 6s, migrate 37s, test_plan 4s, test_apply 3s, drift_reconverge 6s, day2_rename 9s, day2_remove 8s, day2_count 23s, day2_replace 8s, greenfield 21s |
