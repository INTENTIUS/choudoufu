...
10 of 26 estates have a recorded run duration, totaling 33m9.9s, but not from one sweep: 2m41.8s across 1 estate(s) at commit `0a05c31d8a`; 5m41.9s across 1 estate(s) at commit `5621afcab8`; 3m16.2s across 1 estate(s) at commit `5a591a776f`; 11m55.6s across 4 estate(s) at commit `8ef3d258a7`; 1m51s across 1 estate(s) at commit `900ffd671a`; 2m55s across 1 estate(s) at commit `aa5c8a0d45`; 4m48.4s across 1 estate(s) at commit `bfa832dbc9`. This total spans different commits, not a single board run, and excludes 16 estate(s) with no recorded duration yet.
...
| [corpus-leynos-monitoring]({{< relref "corpus-leynos-monitoring" >}}) | 1m51s | cold_deploy 6s, migrate 27s, test_plan 3s, test_apply 3s, drift_reconverge 5s, day2_rename 9s, day2_remove 12s, day2_count 25s, day2_replace 7s, greenfield 14s |
