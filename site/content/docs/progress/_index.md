...
9 of 26 estates have a recorded run duration, totaling 33m10.2s, but not from one sweep: 2m41.8s across 1 estate(s) at commit `0a05c31d8a`; 3m16.2s across 1 estate(s) at commit `5a591a776f`; 11m55.6s across 4 estate(s) at commit `8ef3d258a7`; 2m55s across 1 estate(s) at commit `aa5c8a0d45`; 3m27.4s across 1 estate(s) at commit `c3a37c0e8e`; 8m54.2s across 1 estate(s) at commit `eb631fa5ed`. This total spans different commits, not a single board run, and excludes 17 estate(s) with no recorded duration yet.
...
| [corpus-simpleinfra-dns]({{< relref "corpus-simpleinfra-dns" >}}) | 8m54.2s | cold_deploy 1m12s, migrate 58s, test_plan 11s, test_apply 23s, drift_reconverge 27s, day2_rename 21s, day2_remove 26s, day2_count 54s, day2_replace 1m12s, greenfield 2m50s |
