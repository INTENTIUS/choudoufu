...
9 of 26 estates have a recorded run duration, totaling 31m10.1s, but not from one sweep: 2m41.8s across 1 estate(s) at commit `0a05c31d8a`; 5m41.9s across 1 estate(s) at commit `5621afcab8`; 3m16.2s across 1 estate(s) at commit `5a591a776f`; 11m55.6s across 4 estate(s) at commit `8ef3d258a7`; 4m48.4s across 1 estate(s) at commit `bfa832dbc9`; 2m46.2s across 1 estate(s) at commit `ea08fab812`. This total spans different commits, not a single board run, and excludes 17 estate(s) with no recorded duration yet.
...
| [corpus-iam-read-only-policy]({{< relref "corpus-iam-read-only-policy" >}}) | 2m46.2s | cold_deploy 15s, migrate 1m3s, test_plan 3s, test_apply 3s, drift_reconverge 5s, day2_rename 9s, day2_remove 7s, day2_count 19s, day2_replace 7s, greenfield 35s |
