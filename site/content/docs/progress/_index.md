...
2 of 26 estates have a recorded run duration, totaling 6m46.8s, but not from one sweep: 3m24.4s across 1 estate(s) at commit `0400bd36ed`; 3m22.4s across 1 estate(s) at commit `c8061a4e18`. This total spans different commits, not a single board run, and excludes 24 estate(s) with no recorded duration yet.
...
| [reference-ec2-vpc]({{< relref "reference-ec2-vpc" >}}) | 3m22.4s | cold_deploy 1m23s, migrate 47s, test_plan 2s, test_apply 3s, drift_reconverge 4s, day2_rename 8s, day2_remove 6s, day2_replace 27s, greenfield 3s |
