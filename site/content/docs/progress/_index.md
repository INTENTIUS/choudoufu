...
8 of 26 estates have a recorded run duration, totaling 26m6.2s, but not from one sweep: 2m41.8s across 1 estate(s) at commit `0a05c31d8a`; 3m16.2s across 1 estate(s) at commit `5a591a776f`; 3m24.2s across 1 estate(s) at commit `7b106cad3e`; 11m55.6s across 4 estate(s) at commit `8ef3d258a7`; 4m48.4s across 1 estate(s) at commit `bfa832dbc9`. This total spans different commits, not a single board run, and excludes 18 estate(s) with no recorded duration yet.
...
| [corpus-iam-read-only-policy]({{< relref "corpus-iam-read-only-policy" >}}) | 3m24.2s | cold_deploy 20s, migrate 1m9s, test_plan 4s, test_apply 5s, drift_reconverge 8s, day2_rename 15s, day2_remove 9s, day2_count 27s, day2_replace 10s, greenfield 37s |
