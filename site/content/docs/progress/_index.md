...
9 of 26 estates have a recorded run duration, totaling 30m21.9s, but not from one sweep: 2m41.8s across 1 estate(s) at commit `0a05c31d8a`; 4m44.9s across 1 estate(s) at commit `4303331a70`; 3m16.2s across 1 estate(s) at commit `5a591a776f`; 11m55.6s across 4 estate(s) at commit `8ef3d258a7`; 2m55s across 1 estate(s) at commit `aa5c8a0d45`; 4m48.4s across 1 estate(s) at commit `bfa832dbc9`. This total spans different commits, not a single board run, and excludes 17 estate(s) with no recorded duration yet.
...
| [corpus-hongbomiao-harbor]({{< relref "corpus-hongbomiao-harbor" >}}) | 4m44.9s | cold_deploy 20s, migrate 15s, test_plan 4s, test_apply 6s, drift_reconverge 11s, day2_rename 12s, day2_remove 15s, day2_count 1m51s, day2_replace 13s, greenfield 1m18s |
