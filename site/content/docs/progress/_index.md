...
9 of 26 estates have a recorded run duration, totaling 31m43.2s, but not from one sweep: 3m19.6s across 1 estate(s) at commit `071af51f74`; 5m41.9s across 1 estate(s) at commit `5621afcab8`; 3m16.2s across 1 estate(s) at commit `5a591a776f`; 2m41.5s across 1 estate(s) at commit `845585c76a`; 11m55.6s across 4 estate(s) at commit `8ef3d258a7`; 4m48.4s across 1 estate(s) at commit `bfa832dbc9`. This total spans different commits, not a single board run, and excludes 17 estate(s) with no recorded duration yet.
...
| [corpus-iam-policy]({{< relref "corpus-iam-policy" >}}) | 2m41.5s | cold_deploy 15s, migrate 19s, test_plan 3s, test_apply 3s, drift_reconverge 6s, day2_rename 10s, day2_remove 9s, day2_count 40s, day2_replace 11s, greenfield 45s |
