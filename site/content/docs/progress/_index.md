...
9 of 26 estates have a recorded run duration, totaling 28m32.5s, but not from one sweep: 2m41.8s across 1 estate(s) at commit `0a05c31d8a`; 4m16.5s across 1 estate(s) at commit `168e7ac9a1`; 3m16.2s across 1 estate(s) at commit `5a591a776f`; 11m55.6s across 4 estate(s) at commit `8ef3d258a7`; 2m55s across 1 estate(s) at commit `aa5c8a0d45`; 3m27.4s across 1 estate(s) at commit `c3a37c0e8e`. This total spans different commits, not a single board run, and excludes 17 estate(s) with no recorded duration yet.
...
| [corpus-hongbomiao-labelbox]({{< relref "corpus-hongbomiao-labelbox" >}}) | 4m16.5s | cold_deploy 20s, migrate 54s, test_plan 7s, test_apply 6s, drift_reconverge 11s, day2_rename 15s, day2_remove 14s, day2_count 38s, day2_replace 13s, greenfield 1m18s |
