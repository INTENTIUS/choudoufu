...
8 of 26 estates have a recorded run duration, totaling 30m40.8s, but not from one sweep: 3m16.2s across 1 estate(s) at commit `5a591a776f`; 11m55.6s across 4 estate(s) at commit `8ef3d258a7`; 2m55s across 1 estate(s) at commit `aa5c8a0d45`; 3m27.4s across 1 estate(s) at commit `c3a37c0e8e`; 9m6.6s across 1 estate(s) at commit `c57541ea12`. This total spans different commits, not a single board run, and excludes 18 estate(s) with no recorded duration yet.
...
| [corpus-simpleinfra-dns]({{< relref "corpus-simpleinfra-dns" >}}) | 9m6.6s | cold_deploy 1m10s, migrate 55s, test_plan 10s, test_apply 23s, drift_reconverge 26s, day2_rename 24s, day2_remove 29s, day2_count 1m1s, day2_replace 1m14s, greenfield 2m54s |
