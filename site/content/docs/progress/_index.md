...
10 of 26 estates have a recorded run duration, totaling 34m34.8s, but not from one sweep: 2m41.8s across 1 estate(s) at commit `0a05c31d8a`; 3m15.9s across 1 estate(s) at commit `209b9c8c41`; 5m41.9s across 1 estate(s) at commit `5621afcab8`; 3m16.2s across 1 estate(s) at commit `5a591a776f`; 11m55.6s across 4 estate(s) at commit `8ef3d258a7`; 2m55s across 1 estate(s) at commit `aa5c8a0d45`; 4m48.4s across 1 estate(s) at commit `bfa832dbc9`. This total spans different commits, not a single board run, and excludes 16 estate(s) with no recorded duration yet.
...
| [corpus-hongbomiao-harbor]({{< relref "corpus-hongbomiao-harbor" >}}) | 3m15.9s | cold_deploy 16s, migrate 15s, test_plan 5s, test_apply 3s, drift_reconverge 7s, day2_rename 11s, day2_remove 8s, day2_count 51s, day2_replace 8s, greenfield 1m12s |
