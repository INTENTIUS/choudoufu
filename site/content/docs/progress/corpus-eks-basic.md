...
| Replan from nothing | FAIL | 1 Error diagnostic: aws_launch_configuration is marker-discovered and unlistable, so its 2 instances cannot be found again; the 4 logical-resource refusals are FIXED by choudoufu #364's implied local record store and the 4 count-index ones by sibling_select.go |
...
Last run at commit `b4e69653f0` on 2026-08-22T20:46:57Z, exit code 0.
