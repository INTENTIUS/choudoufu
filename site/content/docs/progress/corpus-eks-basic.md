...
| Greenfield apply | FAIL | the greenfield apply failed - see live/gauntlet/logs/corpus-eks-basic.log for the full diagnostic |
| Strict profile (planned) | not run |  |

Last run at commit `ea221587f5` on 2026-08-25T13:32:43Z, exit code 1.
