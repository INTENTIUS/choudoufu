...
| Replan from nothing | FAIL | 2 known refusals: ignore_changes[tags] on aws_instance.instance and aws_ebs_volume.data_disk (the connection-block refusal this script used to also expect is fixed generically by #353) |
...
Last run at commit `a485d4f7df` on 2026-08-21T20:31:11Z, exit code 1.
