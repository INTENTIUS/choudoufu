...
|---|---|---|
| [Which resource an address means](model-identity.html) | Two tags on the resource | Any cloud tool, and your IAM |
| [Values AWS cannot hold](model-values.html) | A record store you declare | choudoufu only |
| [Effects that read back as nothing](model-effects.html) | A receipt you declare | You, your reviewers, your responder |
...
[Scoping a role](governance.html) has the policies, and the two limits that
...
policies you already run. [Scoping a role](governance.html) has the mechanism
and its limits.
...
[Will my config work](compatibility.html) lists what that rules out.
