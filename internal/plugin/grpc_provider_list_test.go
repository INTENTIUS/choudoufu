...
import (
	...
	mockproto "github.com/intentius/choudoufu/internal/plugin/mock_proto"
...
func newListProvider(t *testing.T, schema *proto.GetProviderSchema_Response, ids *proto.GetResourceIdentitySchemas_Response) (*GRPCProvider, *mockproto.MockProviderClient) {
	...
	client.EXPECT().GetSchema(gomock.Any(), gomock.Any(), gomock.Any()).Return(schema, nil).AnyTimes()
...
func TestGRPCProvider_getProviderSchema_listResourceTypes(t *testing.T) {
...
func TestGRPCProvider_ListResource_includeResourceObject(t *testing.T) {
	p, client := newListProvider(t, listProtoSchema(), listIdentitySchemas())
...
func TestGRPCProvider_ListResource_unimplemented(t *testing.T) {
...
func TestGRPCProvider_ListResource_typeNotListable(t *testing.T) {
...
func TestGRPCProvider_ListResource_transportError(t *testing.T) {
	p, client := newListProvider(t, listProtoSchema(), listIdentitySchemas())
	client.EXPECT().ListResource(gomock.Any(), gomock.Any(), gomock.Any()).Return(
		&fakeListStream{
...
func TestGRPCProvider_ListResource_perEventDiagnostics(t *testing.T) {
	p, client := newListProvider(t, listProtoSchema(), listIdentitySchemas())
	client.EXPECT().ListResource(gomock.Any(), gomock.Any(), gomock.Any()).Return(
...
func TestGRPCProvider_ListResource_identityWithoutSchema(t *testing.T) {
...
func TestGRPCProvider_ListResourceStream_earlyStop(t *testing.T) {
	p, client := newListProvider(t, listProtoSchema(), listIdentitySchemas())
	client.EXPECT().ListResource(gomock.Any(), gomock.Any(), gomock.Any()).Return(
		&fakeListStream{events: []*proto.ListResource_Event{
			{Identity: identityValue(t, "thing-1", "us-east-1")},
