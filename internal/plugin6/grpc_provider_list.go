...
import (
	...
	"github.com/intentius/choudoufu/internal/plugin6/convert"
...
func (p *GRPCProvider) ListResourceStream(ctx context.Context, r providers.ListResourceRequest, emit func(providers.ListResourceEvent) bool) tfdiags.Diagnostics {
	logger.Trace("GRPCProvider.v6: ListResourceStream")
...
func decodeListEvent(typeName string, protoEv *proto6.ListResource_Event, resSchema providers.Schema, hasResSchema bool) (providers.ListResourceEvent, tfdiags.Diagnostics) {
	var diags tfdiags.Diagnostics
