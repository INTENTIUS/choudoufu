...
//
//		TF_FLOCI_TEST=1 go test ./internal/live/lifecycle/ -run TestStatelessSnapshotAgainstFloci -v
//
...
//	    proof is TestSnapshot_noReader in internal/live/projection.
...
// internal/live/projection.Snapshot rather than an import of it: this
