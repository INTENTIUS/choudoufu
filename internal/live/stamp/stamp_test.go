...
var (
	taggableAdmittedTypes = []string{
		...
		// Registry-ratified REMAINDER ratification batch, second slice
		// (#40, #44, #65): APS through CloudTrail. See
...
func testSchemas() Schemas {
	...
	return testSchemaSource{
		...
		// live/survey-full.json's per-type taggable signal (the same
		// source internal/live/stamp/stamp_test.go's two pinned lists
		// above are built from). See live/e2e/estates/remainder/README.md.
		"aws_datapipeline_pipeline":            tagged("id", "arn"),
		...
		"aws_datazone_domain":                  tagged("id", "arn"),
		"aws_detective_graph":                  tagged("id", "arn"),
		"aws_dlm_lifecycle_policy":             tagged("id", "arn"),
		"aws_dms_event_subscription":           tagged("id", "arn"),
		"aws_dms_replication_config":           tagged("id", "arn"),
		"aws_dsql_cluster":                     tagged("id", "arn"),
		"aws_dx_connection":                    tagged("id", "arn"),
		"aws_dx_gateway":                       tagged("id", "arn"),
		"aws_dx_lag":                           tagged("id", "arn"),
		"aws_dx_private_virtual_interface":     tagged("id", "arn"),
		"aws_dx_public_virtual_interface":      tagged("id", "arn"),
		"aws_dx_transit_virtual_interface":     tagged("id", "arn"),
		"aws_ec2_instance_connect_endpoint":    tagged("id", "arn"),
		"aws_ec2_local_gateway_route_table":    tagged("id", "arn"),
		"aws_ec2_local_gateway_route_table_virtual_interface_group_association": tagged("id", "arn"),
		"aws_ec2_local_gateway_route_table_vpc_association":                     tagged("id", "arn"),
		"aws_ec2_network_insights_access_scope":                                 tagged("id", "arn"),
		"aws_ec2_network_insights_analysis":                                     tagged("id", "arn"),
		"aws_ec2_network_insights_path":                                         tagged("id", "arn"),
		"aws_ec2_traffic_mirror_filter":                                         tagged("id", "arn"),
		"aws_ec2_traffic_mirror_session":                                        tagged("id", "arn"),
		"aws_ec2_traffic_mirror_target":                                         tagged("id", "arn"),
		"aws_ecs_daemon_task_definition":                                        tagged("id", "arn"),
		"aws_ecs_express_gateway_service":                                       tagged("id", "arn"),
		"aws_ecs_task_definition":                                               tagged("id", "arn"),
		"aws_egress_only_internet_gateway":                                      tagged("id", "arn"),
		"aws_elb":                                                               tagged("id", "arn"),
		"aws_evidently_project":                                                 tagged("id", "arn"),
		"aws_evidently_segment":                                                 tagged("id", "arn"),
		"aws_fis_experiment_template":                                           tagged("id", "arn"),
		"aws_fms_resource_set":                                                  tagged("id", "arn"),
		"aws_gamelift_alias":                                                    tagged("id", "arn"),
		"aws_gamelift_build":                                                    tagged("id", "arn"),
		"aws_gamelift_fleet":                                                    tagged("id", "arn"),
		"aws_gamelift_script":                                                   tagged("id", "arn"),
		"aws_glue_data_quality_ruleset":                                         tagged("id", "arn"),
		"aws_glue_schema":                                                       tagged("id", "arn"),
		"aws_glue_workflow":                                                     tagged("id", "arn"),
		"aws_iam_saml_provider":                                                 tagged("id", "arn"),
		"aws_iam_virtual_mfa_device":                                            tagged("id", "arn"),
		"aws_imagebuilder_component":                                            tagged("id", "arn"),
		"aws_imagebuilder_container_recipe":                                     tagged("id", "arn"),
		"aws_imagebuilder_distribution_configuration":                           tagged("id", "arn"),
		"aws_imagebuilder_image":                                                tagged("id", "arn"),
		"aws_imagebuilder_image_pipeline":                                       tagged("id", "arn"),
		"aws_imagebuilder_image_recipe":                                         tagged("id", "arn"),
		"aws_imagebuilder_infrastructure_configuration":                         tagged("id", "arn"),
		"aws_imagebuilder_lifecycle_policy":                                     tagged("id", "arn"),
		"aws_imagebuilder_workflow":                                             tagged("id", "arn"),
		"aws_inspector_assessment_template":                                     tagged("id", "arn"),
		"aws_internetmonitor_monitor":                                           tagged("id", "arn"),
		"aws_invoicing_invoice_unit":                                            tagged("id", "arn"),
		"aws_iot_provisioning_template":                                         tagged("id", "arn"),
		"aws_iot_topic_rule":                                                    tagged("id", "arn"),
		"aws_kinesis_analytics_application":                                     tagged("id", "arn"),
		"aws_lb_listener_rule":                                                  tagged("id", "arn"),
		"aws_lb_trust_store":                                                    tagged("id", "arn"),
		"aws_m2_application":                                                    tagged("id", "arn"),
		"aws_m2_environment":                                                    tagged("id", "arn"),
		"aws_mailmanager_rule_set":                                              tagged("id", "arn"),
		"aws_mailmanager_traffic_policy":                                        tagged("id", "arn"),
		"aws_msk_replicator":                                                    tagged("id", "arn"),
		"aws_msk_vpc_connection":                                                tagged("id", "arn"),
		"aws_mwaa_environment":                                                  tagged("id", "arn"),
		"aws_notifications_notification_configuration":                          tagged("id", "arn"),
		"aws_notificationscontacts_email_contact":                               tagged("id", "arn"),
		"aws_oam_link":                                                          tagged("id", "arn"),
		"aws_oam_sink":                                                          tagged("id", "arn"),
		"aws_observabilityadmin_s3_table_integration":                           tagged("id", "arn"),
		"aws_observabilityadmin_telemetry_pipeline":                             tagged("id", "arn"),
		"aws_odb_cloud_autonomous_vm_cluster":                                   tagged("id", "arn"),
		"aws_odb_cloud_exadata_infrastructure":                                  tagged("id", "arn"),
		"aws_odb_cloud_vm_cluster":                                              tagged("id", "arn"),
		"aws_odb_network":                                                       tagged("id", "arn"),
		"aws_odb_network_peering_connection":                                    tagged("id", "arn"),
		"aws_paymentcryptography_key":                                           tagged("id", "arn"),
		"aws_pinpointsmsvoicev2_configuration_set":                              tagged("id", "arn"),
		"aws_pinpointsmsvoicev2_opt_out_list":                                   tagged("id", "arn"),
		"aws_pinpointsmsvoicev2_phone_number":                                   tagged("id", "arn"),
		"aws_pinpointsmsvoicev2_pool":                                           tagged("id", "arn"),
		"aws_ram_permission":                                                    tagged("id", "arn"),
		"aws_ram_resource_share":                                                tagged("id", "arn"),
		"aws_rbin_rule":                                                         tagged("id", "arn"),
		"aws_resiliencehub_resiliency_policy":                                   tagged("id", "arn"),
		"aws_resiliencehubv2_policy":                                            tagged("id", "arn"),
		"aws_rolesanywhere_profile":                                             tagged("id", "arn"),
		"aws_rolesanywhere_trust_anchor":                                        tagged("id", "arn"),
		"aws_s3_directory_bucket":                                               tagged("id", "arn"),
		"aws_s3control_bucket":                                                  tagged("id", "arn"),
		"aws_s3files_access_point":                                              tagged("id", "arn"),
		"aws_s3files_file_system":                                               tagged("id", "arn"),
		"aws_s3tables_table_bucket":                                             tagged("id", "arn"),
		"aws_s3vectors_index":                                                   tagged("id", "arn"),
		"aws_s3vectors_vector_bucket":                                           tagged("id", "arn"),
		"aws_schemas_discoverer":                                                tagged("id", "arn"),
		"aws_securitylake_data_lake":                                            tagged("id", "arn"),
		"aws_securitylake_subscriber":                                           tagged("id", "arn"),
		"aws_service_discovery_http_namespace":                                  tagged("id", "arn"),
		"aws_service_discovery_public_dns_namespace":                            tagged("id", "arn"),
		"aws_service_discovery_service":                                         tagged("id", "arn"),
		"aws_sesv2_configuration_set":                                           tagged("id", "arn"),
		"aws_sesv2_dedicated_ip_pool":                                           tagged("id", "arn"),
		"aws_sesv2_email_identity":                                              tagged("id", "arn"),
		"aws_sesv2_tenant":                                                      tagged("id", "arn"),
		"aws_shield_protection":                                                 tagged("id", "arn"),
		"aws_ssmcontacts_contact":                                               tagged("id", "arn"),
		"aws_ssmcontacts_rotation":                                              tagged("id", "arn"),
		...
		"aws_transfer_connector":                                                tagged("id", "arn"),
		...
		"aws_verifiedpermissions_policy_store":                                  tagged("id", "arn"),
		"aws_vpc_block_public_access_exclusion":                                 tagged("id", "arn"),
		"aws_vpc_encryption_control":                                            tagged("id", "arn"),
		"aws_vpc_route_server":                                                  tagged("id", "arn"),
		"aws_vpc_route_server_endpoint":                                         tagged("id", "arn"),
		"aws_vpc_route_server_peer":                                             tagged("id", "arn"),
		"aws_vpn_concentrator":                                                  tagged("id", "arn"),
		...
		"aws_iot_topic_rule_destination":                                        untagged("id"),
		"aws_kinesis_resource_policy":                                           untagged("id"),
		"aws_macie2_account":                                                    untagged("id"),
		"aws_msk_cluster_policy":                                                untagged("id"),
		"aws_notifications_event_rule":                                          untagged("id"),
		"aws_notifications_notification_hub":                                    untagged("id"),
		"aws_route53_cidr_collection":                                           untagged("id"),
		"aws_route53_resolver_dnssec_config":                                    untagged("id"),
		"aws_route53_resolver_query_log_config_association":                     untagged("id"),
		"aws_route53profiles_resource_association":                              untagged("id"),
		"aws_route53recoverycontrolconfig_routing_control":                      untagged("id"),
		"aws_s3control_multi_region_access_point":                               untagged("id"),
		"aws_s3files_file_system_policy":                                        untagged("id"),
		"aws_s3files_mount_target":                                              untagged("id"),
		"aws_s3tables_table_bucket_policy":                                      untagged("id"),
		"aws_s3vectors_vector_bucket_policy":                                    untagged("id"),
		"aws_securityhub_account":                                               untagged("id"),
		"aws_securityhub_configuration_policy":                                  untagged("id"),
		"aws_securityhub_finding_aggregator":                                    untagged("id"),
		"aws_securityhub_insight":                                               untagged("id"),
		"aws_securityhub_organization_configuration":                            untagged("id"),
		"aws_securityhub_standards_subscription":                                untagged("id"),
		"aws_sesv2_account_vdm_attributes":                                      untagged("id"),
		"aws_sfn_alias":                                                         untagged("id"),
		"aws_shield_proactive_engagement":                                       untagged("id"),
		"aws_sns_topic_subscription":                                            untagged("id"),
		"aws_ssmcontacts_contact_channel":                                       untagged("id"),
		"aws_ssmcontacts_plan":                                                  untagged("id"),

		// Registry-ratified REMAINDER ratification batch, second slice
		// (#40, #44, #65): APS through CloudTrail. See
		// live/e2e/estates/remainder/README.md.
		"aws_prometheus_rule_group_namespace":                      tagged("id", "arn"),
		"aws_arcregionswitch_plan":                                 tagged("id", "arn"),
		"aws_appconfig_application":                                tagged("id", "arn"),
		"aws_appconfig_deployment_strategy":                        tagged("id", "arn"),
		"aws_appconfig_extension":                                  tagged("id", "arn"),
		"aws_appintegrations_data_integration":                     tagged("id", "arn"),
		"aws_appintegrations_event_integration":                    tagged("id", "arn"),
		"aws_bcmdataexports_export":                                tagged("id", "arn"),
		"aws_billing_view":                                         tagged("id", "arn"),
		"aws_ce_anomaly_monitor":                                   tagged("id", "arn"),
		"aws_ce_anomaly_subscription":                              tagged("id", "arn"),
		"aws_ce_cost_category":                                     tagged("id", "arn"),
		"aws_cur_report_definition":                                tagged("id", "arn"),
		"aws_chatbot_slack_channel_configuration":                  tagged("id", "arn"),
		"aws_cleanrooms_collaboration":                             tagged("id", "arn"),
		"aws_cleanrooms_configured_table":                          tagged("id", "arn"),
		"aws_cleanrooms_membership":                                tagged("id", "arn"),
		"aws_cloud9_environment_ec2":                               tagged("id", "arn"),
		"aws_cloudtrail":                                           tagged("id", "arn"),
		"aws_cloudtrail_event_data_store":                          tagged("id", "arn"),
		"aws_codegurureviewer_repository_association":              tagged("id", "arn"),
		"aws_prometheus_scraper":                                   tagged("id", "arn"),
		"aws_prometheus_workspace":                                 tagged("id", "arn"),
		"aws_appsync_api":                                          tagged("id", "arn"),
		"aws_arczonalshift_zonal_autoshift_configuration":          untagged("id"),
		"aws_appconfig_extension_association":                      untagged("id"),
		"aws_athena_named_query":                                   untagged("id"),
		"aws_autoscaling_group":                                    untagged("id"),
		"aws_launch_configuration":                                 untagged("id"),
		"aws_cloudfront_cache_policy":                              untagged("id"),
		"aws_cloudfront_continuous_deployment_policy":              untagged("id"),
		"aws_cloudfront_key_group":                                 untagged("id"),
		"aws_cloudfront_origin_access_identity":                    untagged("id"),
		"aws_cloudfront_origin_request_policy":                     untagged("id"),
		"aws_cloudfront_public_key":                                untagged("id"),
		"aws_cloudfront_response_headers_policy":                   untagged("id"),
		"aws_arczonalshift_autoshift_observer_notification_status": untagged("id"),
		"aws_appsync_api_cache":                                    untagged("id"),
		"aws_appsync_domain_name_api_association":                  untagged("id"),
