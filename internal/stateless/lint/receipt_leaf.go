...
// stateless/RECEIPTS.md defines for a receipt: a resource of this type
...
// is statically recognizable as a receipt (stateless/RECEIPTS.md, "the leaf
	...
	*issues = append(*issues, Issue{
		...
		Detail: fmt.Sprintf(
			"%q is a receipt under the /tofu-receipts/ naming convention "+
				"(stateless/RECEIPTS.md). Nothing may reference a receipt's attributes: a "+
