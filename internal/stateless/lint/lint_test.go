...
func TestCheckEstate(t *testing.T) {
	...
	// it is an e2e fixture rather than a lint fixture: stateless/e2e/estate
	// relative to the root, and this package is internal/stateless/lint.
	estate := filepath.Join("..", "..", "..", "stateless", "e2e", "estate")
