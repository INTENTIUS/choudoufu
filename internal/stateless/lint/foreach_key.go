...
// stateless run has. stateless/MARKERS.md therefore bounds what a key may
...
// internal/stateless/stamp. The declared side of the comparison renders an
...
// value set from stateless/MARKERS.md minus the two escaped-address
...
// internal/stateless/identity refuses to resolve a resource whose expansion
...
// internal/stateless/identity words its refusal the same way.
