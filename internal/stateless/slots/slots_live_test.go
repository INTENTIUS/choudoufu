...
//
//	TF_FLOCI_TEST=1 go test ./internal/stateless/slots/ -run TestSlotsAgainstFloci -v -timeout 30m
//
...
const poolFixture = `# Written by internal/stateless/slots's integration test.
