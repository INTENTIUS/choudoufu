...
// Package markers is stateless/MARKERS.md in code: the ownership tag keys,
...
// The three marker tag keys, from stateless/MARKERS.md. They are the entire
...
//
// The escaping rule in stateless/MARKERS.md is lossy in two ways, and this
