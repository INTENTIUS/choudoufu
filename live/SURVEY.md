...
| Status | Meaning | Rows |
|---|---|---|
| `wired` | in the fork's admission table (`internal/live/lint/admission.go`) and identity table (`internal/live/identity/table.go`) today | <!-- survey-gen:begin wired-count -->93<!-- survey-gen:end wired-count --> |
