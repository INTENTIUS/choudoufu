...
most of it, see [Identity](https://intentius.io/choudoufu/docs/model/identity/). To check
...
- Every `kubernetes_*` type whose schema carries object metadata resolves
  ...
  The [Kubernetes hub](https://intentius.io/choudoufu/kubernetes/) says what is proven
...
context, and [Resource tier lookup](https://intentius.io/choudoufu/docs/use/resource-tiers/) carries it broken out per type, in customer language, with a reason for
...
lookup](https://intentius.io/choudoufu/docs/use/resource-tiers/) separates them.
...
[Identity](https://intentius.io/choudoufu/docs/model/identity/) states the rule in full.
...
module](https://intentius.io/choudoufu/docs/use/keyed-modules/).
...
measured](https://intentius.io/choudoufu/docs/use/measurement/).
