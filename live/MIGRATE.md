...
[What you set up by hand](https://intentius.io/choudoufu/docs/use/setup/#deleting-the-state-file-is-not-enforced)
...
[roundtrip claim](smoke/claims/roundtrip.md)
...
[stock-when-you-need-it claim](smoke/claims/stock-when-you-need-it.md)'s
...
govern](https://intentius.io/choudoufu/docs/use/ownership-policy/#what-the-matrix-does-not-govern)
...
cannot declare. [Compatibility reference](https://intentius.io/choudoufu/docs/use/compatibility/) covers finding yours.
...
leaves both untouched. [The ownership policy matrix](https://intentius.io/choudoufu/docs/use/ownership-policy/) covers the rest of the
matrix.
