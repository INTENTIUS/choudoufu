...
2. `readiness-gen` rebuilds `live/readiness.json`
   ([the four-tier partition](https://intentius.io/choudoufuresource-tiers/)) from the new
   survey.
...
- **Tier/status movement.** Every type whose entry in `live/readiness.json`
  ...
  [the resource-tier lookup](https://intentius.io/choudoufuresource-tiers/) actually feels.
