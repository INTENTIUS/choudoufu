...
| 127 | 2231 | identity | Dynamic value in static context | `internal/configs` | "Dynamic value in static context" |
| 114 | 1646 | lint | unadmitted-type | `internal/live/lint` | "unadmitted-type" |
| 86 | 3539 | identity | Unable to compute static value | `internal/configs` | "Unable to compute static value" |
...
| 32 | 84 | identity | Not an identity attribute | `internal/live/identity` | "Not an identity attribute" |
...
| 18 | 71 | identity | Identity not resolvable from configuration | `internal/live/identity` | "Identity not resolvable from configuration" |
...
**How often.** Blocked 127 configurations in the measured corpus, at 2231 sites.
...
**How often.** Blocked 86 configurations in the measured corpus, at 3539 sites.
...
**How often.** Blocked 32 configurations in the measured corpus, at 84 sites.
...
**How often.** Blocked 18 configurations in the measured corpus, at 71 sites.
