...
`aws_quicksight_refresh_schedule`, `aws_ram_resource_association`,
...
**Total.** 157 types swept via a parent read.
...
`aws_licensemanager_association`, `aws_lightsail_domain`,
