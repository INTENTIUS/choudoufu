...
| [`rowgen-annotation-rulings`](#rowgen-annotation-rulings) | 92 | at most 92 | `live/rowgen-convergence.json summary.admitted_total` at 893, floor 850 | #132 |
| [`rowgen-unannotated-mismatches`](#rowgen-unannotated-mismatches) | 0 | at most 0 | `live/rowgen-convergence.json summary.compared` at 879, floor 800 | #132 |
| [`unreached-types`](#unreached-types) | 620 | at most 620 | `live/survey-full.json counts.types` at 1699, floor 1600 | #245, #246 |
...
every ruling names one of the 879 types the convergence artifact carries, over 893 admitted types.
...
recomputed from 879 compared rows: 92 unmatched, every one of them named by one of the ledger's 92 rulings.
...
Now **620 provider resource types**, at most **620**. At the bound.

893 admitted, 81 hand-vetoed, 148 markerless-vetoed, over a roster of 1699.
