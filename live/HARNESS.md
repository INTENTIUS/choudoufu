...
| [`rowgen-annotation-rulings`](#rowgen-annotation-rulings) | 98 | at most 98 | `live/rowgen-convergence.json summary.admitted_total` at 966, floor 850 | #132 |
| [`rowgen-unannotated-mismatches`](#rowgen-unannotated-mismatches) | 0 | at most 0 | `live/rowgen-convergence.json summary.compared` at 952, floor 800 | #132 |
| [`unreached-types`](#unreached-types) | 552 | at most 613 | `live/survey-full.json counts.types` at 1699, floor 1600 | #245, #246 |
...
Now **98 rulings**, at most **98**. At the bound.

every ruling names one of the 952 types the convergence artifact carries, over 966 admitted types.
...
recomputed from 952 compared rows: 98 unmatched, every one of them named by one of the ledger's 98 rulings.
...
Now **552 provider resource types**, at most **613**, so the bound is stale by 61 and should be lowered to the measurement.

966 admitted, 83 hand-vetoed, 140 markerless-vetoed, over a roster of 1699.
