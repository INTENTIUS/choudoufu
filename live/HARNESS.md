...
| [`rowgen-annotation-rulings`](#rowgen-annotation-rulings) | 143 | at most 143 | `live/rowgen-convergence.json summary.admitted_total` at 952, floor 850 | #132 |
| [`rowgen-unannotated-mismatches`](#rowgen-unannotated-mismatches) | 0 | at most 0 | `live/rowgen-convergence.json summary.compared` at 938, floor 800 | #132 |
| [`unreached-types`](#unreached-types) | 551 | at most 613 | `live/survey-full.json counts.types` at 1699, floor 1600 | #245, #246 |
...
every ruling names one of the 938 types the convergence artifact carries, over 952 admitted types.
...
recomputed from 938 compared rows: 143 unmatched, every one of them named by one of the ledger's 143 rulings.
...
Now **551 provider resource types**, at most **613**, so the bound is stale by 62 and should be lowered to the measurement.

952 admitted, 98 hand-vetoed, 140 markerless-vetoed, over a roster of 1699.
