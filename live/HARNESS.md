...
| [`rowgen-annotation-rulings`](#rowgen-annotation-rulings) | 92 | at most 92 | `live/rowgen-convergence.json summary.admitted_total` at 895, floor 850 | #132 |
| [`rowgen-unannotated-mismatches`](#rowgen-unannotated-mismatches) | 0 | at most 0 | `live/rowgen-convergence.json summary.compared` at 881, floor 800 | #132 |
| [`unreached-types`](#unreached-types) | 618 | at most 618 | `live/survey-full.json counts.types` at 1699, floor 1600 | #245, #246 |
...
every ruling names one of the 881 types the convergence artifact carries, over 895 admitted types.
...
recomputed from 881 compared rows: 92 unmatched, every one of them named by one of the ledger's 92 rulings.
...
Now **618 provider resource types**, at most **618**. At the bound.

895 admitted, 81 hand-vetoed, 148 markerless-vetoed, over a roster of 1699.
