...
| [`rowgen-annotation-rulings`](#rowgen-annotation-rulings) | 122 | at most 122 | `live/rowgen-convergence.json summary.admitted_total` at 990, floor 850 | #132 |
| [`rowgen-unannotated-mismatches`](#rowgen-unannotated-mismatches) | 0 | at most 0 | `live/rowgen-convergence.json summary.compared` at 976, floor 800 | #132 |
| [`unreached-types`](#unreached-types) | 525 | at most 613 | `live/survey-full.json counts.types` at 1699, floor 1600 | #245, #246 |
...
every ruling names one of the 976 types the convergence artifact carries, over 990 admitted types.
...
recomputed from 976 compared rows: 122 unmatched, every one of them named by one of the ledger's 122 rulings.
...
Now **525 provider resource types**, at most **613**, so the bound is stale by 88 and should be lowered to the measurement.

990 admitted, 86 hand-vetoed, 140 markerless-vetoed, over a roster of 1699.
