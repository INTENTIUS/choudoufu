...
| [`rowgen-annotation-rulings`](#rowgen-annotation-rulings) | 150 | at most 150 | `live/rowgen-mismatches.json summary.admitted_total` at 1049, floor 850 | #132 |
...
Now **150 rulings**, at most **150**. At the bound.
...
- 150 on 2026-09-22 (issue #1316): the first fall this ledger has recorded, and it is a ruling retired by correcting the ratified row rather than by teaching the generator. The aws_securityhub_connector_v2 ruling excused a ratified IdentityAttrs of [id, connector_id] against the fresh proposal's [connector_id], reading the extra id as a ratifier-verified alias. The pinned-provider check (TestIdentityTableAgainstThePinnedProvider, hashicorp/aws 6.59.0) found the type has no id attribute: it is a plugin-framework resource, and the alias was a reference target the provider does not serve. With the row corrected to [connector_id] the fresh proposal matches it, row-gen -mismatches reported the ruling stale, and it was deleted. 151 - 1 = 150.
...
recomputed from 1023 compared rows: 146 unmatched, every one of them named by one of the ledger's 150 rulings.
