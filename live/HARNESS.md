...
| [`rowgen-annotation-rulings`](#rowgen-annotation-rulings) | 146 | at most 146 | `live/rowgen-convergence.json summary.admitted_total` at 1036, floor 850 | #132 |
| [`rowgen-unannotated-mismatches`](#rowgen-unannotated-mismatches) | 0 | at most 0 | `live/rowgen-convergence.json summary.compared` at 1022, floor 800 | #132 |
| [`unreached-types`](#unreached-types) | 465 | at most 613 | `live/survey-full.json counts.types` at 1699, floor 1600 | #245, #246 |
...
every ruling names one of the 1022 types the convergence artifact carries, over 1036 admitted types.
...
recomputed from 1022 compared rows: 146 unmatched, every one of them named by one of the ledger's 146 rulings.
...
Now **465 provider resource types**, at most **613**, so the bound is stale by 148 and should be lowered to the measurement.

1036 admitted, 100 hand-vetoed, 140 markerless-vetoed, over a roster of 1699.
