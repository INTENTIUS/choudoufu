...
| Admitted (the shipped table) | 966 types | Nothing at lint. Runtime support varies by type; see the layers below. |
...
966<!-- survey-gen:end contract-count --> types: <!-- survey-gen:begin contract-types -->
  ...
  `aws_kms_replica_key`, `aws_lakeformation_lf_tag`,
  ...
  `aws_servicecatalog_product`, `aws_servicecatalog_provisioned_product`,
  ...
  `aws_shield_protection_group`, `aws_sns_topic`, `aws_sns_topic_policy`,
  `aws_spot_fleet_request`, `aws_sqs_queue`, `aws_sqs_queue_policy`,
  `aws_ssm_association`, `aws_ssm_maintenance_window`, `aws_ssm_parameter`,
