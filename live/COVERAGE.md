...
| Admitted (the shipped table) | 1011 types | Nothing at lint. Runtime support varies by type; see the layers below. |
...
1011<!-- survey-gen:end contract-count --> types: <!-- survey-gen:begin contract-types -->
