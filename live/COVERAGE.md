...
958<!-- survey-gen:end contract-count --> types: <!-- survey-gen:begin contract-types -->
  ...
  `aws_amplify_domain_association`, `aws_api_gateway_account`,
  ...
  `aws_appsync_api`, `aws_appsync_api_cache`, `aws_appsync_channel_namespace`,
  ...
  `aws_codebuild_source_credential`, `aws_codebuild_webhook`,
  ...
  `aws_glue_catalog`, `aws_glue_catalog_database`, `aws_glue_catalog_table`,
  ...
  `aws_glue_ml_transform`, `aws_glue_registry`, `aws_glue_schema`,
  `aws_glue_security_configuration`, `aws_glue_trigger`,
  `aws_glue_user_defined_function`, `aws_glue_workflow`,
  `aws_grafana_workspace`, `aws_guardduty_detector`, `aws_guardduty_filter`,
  `aws_guardduty_ipset`, `aws_guardduty_malware_protection_plan`,
  ...
  `aws_network_interface_permission`, `aws_network_interface_sg_attachment`,
  ...
  `aws_networkflowmonitor_monitor`, `aws_networkmanager_connect_attachment`,
  `aws_networkmanager_connect_peer`, `aws_networkmanager_core_network`,
  ...
  `aws_redshift_endpoint_access`, `aws_redshift_parameter_group`,
  ...
  `aws_route53_resolver_dnssec_config`, `aws_route53_resolver_endpoint`,
  ...
  `aws_secretsmanager_secret_rotation`, `aws_security_group`,
  ...
  `aws_shield_protection`, `aws_shield_protection_group`, `aws_sns_topic`,
  ...
  `aws_vpc`, `aws_vpc_block_public_access_exclusion`,
