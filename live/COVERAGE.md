...
| Admitted (the shipped table) | 952 types | Nothing at lint. Runtime support varies by type; see the layers below. |
...
952<!-- survey-gen:end contract-count --> types: <!-- survey-gen:begin contract-types -->
  ...
  `aws_secretsmanager_secret_rotation`, `aws_secretsmanager_tag`,
