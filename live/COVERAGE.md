...
| Admitted (the shipped table) | 908 types | Nothing at lint. Runtime support varies by type; see the layers below. |
...
908<!-- survey-gen:end contract-count --> types: <!-- survey-gen:begin contract-types -->
  ...
  `aws_appautoscaling_target`, `aws_appconfig_application`,
  `aws_appconfig_configuration_profile`, `aws_appconfig_deployment`,
  `aws_appconfig_deployment_strategy`, `aws_appconfig_environment`,
  `aws_appconfig_extension`, `aws_appconfig_extension_association`,
  ...
  `aws_appstream_fleet_stack_association`, `aws_appstream_stack`,
  `aws_appstream_user`, `aws_appsync_api`, `aws_appsync_api_cache`,
  `aws_appsync_channel_namespace`, `aws_appsync_domain_name`,
  `aws_appsync_domain_name_api_association`, `aws_appsync_graphql_api`,
  ...
  `aws_athena_data_catalog`, `aws_athena_named_query`, `aws_athena_workgroup`,
  `aws_auditmanager_assessment`, `aws_auditmanager_framework`,
  `aws_autoscaling_group`, `aws_backup_framework`,
  ...
  `aws_bedrockagentcore_gateway`, `aws_bedrockagentcore_gateway_rule`,
  `aws_bedrockagentcore_harness`, `aws_bedrockagentcore_memory`,
  ...
  `aws_bedrockagentcore_resource_policy`, `aws_billing_view`,
  `aws_budgets_budget_action`, `aws_ce_anomaly_monitor`,
  ...
  `aws_cloudfront_function`, `aws_cloudfront_key_group`,
  ...
  `aws_config_config_rule`, `aws_config_configuration_aggregator`,
  ...
  `aws_connect_phone_number`, `aws_connect_queue`,
  ...
  `aws_customer_gateway`, `aws_datapipeline_pipeline`, `aws_datasync_agent`,
  ...
  `aws_datasync_location_smb`, `aws_datasync_task`, `aws_datazone_domain`,
  `aws_datazone_environment_blueprint_configuration`,
  `aws_datazone_form_type`, `aws_db_event_subscription`, `aws_db_instance`,
  ...
  `aws_devopsguru_notification_channel`, `aws_devopsguru_resource_collection`,
  ...
  `aws_dx_transit_virtual_interface`, `aws_dynamodb_global_secondary_index`,
  ...
  `aws_ec2_instance_connect_endpoint`, `aws_ec2_local_gateway_route_table`,
  ...
  `aws_elasticsearch_domain`, `aws_elb`, `aws_emr_cluster`,
  ...
  `aws_fis_experiment_template`, `aws_flow_log`, `aws_fms_resource_set`,
  ...
  `aws_gamelift_script`, `aws_globalaccelerator_accelerator`,
  ...
  `aws_glue_data_quality_ruleset`, `aws_glue_job`, `aws_glue_ml_transform`,
  `aws_glue_registry`, `aws_glue_schema`, `aws_glue_security_configuration`,
  `aws_glue_trigger`, `aws_glue_workflow`, `aws_grafana_workspace`,
  ...
  `aws_inspector_assessment_template`, `aws_inspector_resource_group`,
  `aws_instance`, `aws_internet_gateway`, `aws_internetmonitor_monitor`,
  `aws_invoicing_invoice_unit`, `aws_iot_authorizer`, `aws_iot_billing_group`,
  `aws_iot_ca_certificate`, `aws_iot_domain_configuration`, `aws_iot_policy`,
  ...
  `aws_m2_application`, `aws_m2_environment`, `aws_macie2_account`,
  ...
  `aws_msk_scram_secret_association`, `aws_msk_serverless_cluster`,
  ...
  `aws_network_acl`, `aws_network_acl_association`, `aws_network_acl_rule`,
  `aws_network_interface`, `aws_network_interface_attachment`,
  `aws_network_interface_permission`, `aws_networkfirewall_firewall`,
  ...
  `aws_networkmanager_vpc_attachment`, `aws_notifications_event_rule`,
  ...
  `aws_opensearch_domain`, `aws_opensearchserverless_access_policy`,
  ...
  `aws_organizations_resource_policy`, `aws_osis_pipeline`,
  `aws_paymentcryptography_key`, `aws_paymentcryptography_key_alias`,
  ...
  `aws_pipes_pipe`, `aws_placement_group`,
  ...
  `aws_qbusiness_application`, `aws_qldb_ledger`, `aws_ram_permission`,
  `aws_ram_resource_share`, `aws_rbin_rule`, `aws_rds_cluster`,
  `aws_rds_cluster_instance`, `aws_rds_cluster_parameter_group`,
  `aws_rds_cluster_role_association`, `aws_rds_custom_db_engine_version`,
  `aws_rds_global_cluster`, `aws_rds_integration`, `aws_rds_shard_group`,
  `aws_redshift_cluster`, `aws_redshift_endpoint_access`,
  `aws_redshift_parameter_group`, `aws_redshift_snapshot_schedule`,
  `aws_redshift_subnet_group`, `aws_redshiftserverless_namespace`,
  `aws_redshiftserverless_workgroup`, `aws_rekognition_collection`,
  `aws_rekognition_project`, `aws_rekognition_stream_processor`,
  `aws_resiliencehub_resiliency_policy`, `aws_resiliencehubv2_policy`,
  `aws_resiliencehubv2_service`, `aws_resiliencehubv2_system`,
  `aws_resourceexplorer2_index`, `aws_resourceexplorer2_view`,
  `aws_resourcegroups_group`, `aws_rolesanywhere_profile`,
  `aws_rolesanywhere_trust_anchor`, `aws_route`,
  `aws_route53_cidr_collection`, `aws_route53_health_check`,
  ...
  `aws_route53_zone`, `aws_route53_zone_association`,
  `aws_route53profiles_association`, `aws_route53profiles_profile`,
  ...
  `aws_s3files_mount_target`, `aws_s3outposts_endpoint`,
  ...
  `aws_sagemaker_hub`, `aws_sagemaker_image`, `aws_sagemaker_mlflow_app`,
  ...
  `aws_sagemaker_pipeline`, `aws_sagemaker_project`, `aws_sagemaker_space`,
  ...
  `aws_securityhub_connector_v2`, `aws_securityhub_finding_aggregator`,
  `aws_securityhub_insight`, `aws_securityhub_member`,
  ...
  `aws_sesv2_email_identity`, `aws_sesv2_tenant`, `aws_sfn_activity`,
  `aws_sfn_alias`, `aws_sfn_state_machine`, `aws_shield_proactive_engagement`,
  `aws_shield_protection`, `aws_sns_topic`, `aws_sns_topic_policy`,
  `aws_sns_topic_subscription`, `aws_spot_fleet_request`, `aws_sqs_queue`,
  `aws_sqs_queue_policy`, `aws_ssm_association`, `aws_ssm_maintenance_window`,
  `aws_ssm_maintenance_window_task`, `aws_ssm_parameter`,
  `aws_ssm_patch_baseline`, `aws_ssm_patch_group`,
  `aws_ssm_resource_data_sync`, `aws_ssm_service_setting`,
  `aws_ssmcontacts_contact`, `aws_ssmcontacts_contact_channel`,
  `aws_ssmcontacts_plan`, `aws_ssmcontacts_rotation`,
  ...
  `aws_synthetics_group`, `aws_timestreaminfluxdb_db_cluster`,
  `aws_timestreaminfluxdb_db_instance`, `aws_timestreamquery_scheduled_query`,
  ...
  `aws_verifiedpermissions_policy`, `aws_verifiedpermissions_policy_store`,
  `aws_verifiedpermissions_policy_template`, `aws_volume_attachment`,
  `aws_vpc`, `aws_vpc_block_public_access_exclusion`, `aws_vpc_dhcp_options`,
  `aws_vpc_dhcp_options_association`, `aws_vpc_encryption_control`,
  `aws_vpc_endpoint`, `aws_vpc_endpoint_connection_notification`,
