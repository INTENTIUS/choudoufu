...
| Pastable proposals (server-assigned 582, client-named 361, composite 106, assembled 8) | 1057 types | A ratification batch: paste, fixture, test. |
...
843<!-- survey-gen:end contract-count --> types: <!-- survey-gen:begin contract-types -->
  ...
  `aws_appconfig_application`, `aws_appconfig_deployment_strategy`,
  ...
  `aws_appsync_api`, `aws_appsync_api_cache`,
  ...
  `aws_ce_cost_category`, `aws_chatbot_slack_channel_configuration`,
  `aws_cleanrooms_collaboration`, `aws_cleanrooms_configured_table`,
  `aws_cleanrooms_membership`, `aws_cloud9_environment_ec2`,
  `aws_cloudfront_anycast_ip_list`, `aws_cloudfront_cache_policy`,
  ...
  `aws_connect_instance`, `aws_connect_phone_number`, `aws_connect_queue`,
  ...
  `aws_resiliencehubv2_policy`, `aws_resourceexplorer2_index`,
  ...
  `aws_s3control_bucket`, `aws_s3control_multi_region_access_point`,
  `aws_s3files_access_point`, `aws_s3files_file_system`,
  ...
  `aws_sesv2_dedicated_ip_pool`, `aws_sesv2_email_identity`,
  `aws_sesv2_tenant`, `aws_sfn_activity`, `aws_sfn_alias`,
  `aws_sfn_state_machine`, `aws_shield_proactive_engagement`,
  ...
  `aws_ssm_parameter`, `aws_ssm_patch_baseline`, `aws_ssm_patch_group`,
  ...
  `aws_ssoadmin_permission_set`, `aws_storagegateway_tape_pool`, `aws_subnet`,
  `aws_synthetics_canary`, `aws_synthetics_group`,
  ...
  `aws_timestreamwrite_table`, `aws_transfer_agreement`,
  `aws_transfer_certificate`, `aws_transfer_connector`,
  `aws_transfer_profile`, `aws_transfer_server`, `aws_transfer_user`,
  `aws_transfer_web_app`, `aws_transfer_web_app_customization`,
  `aws_transfer_workflow`, `aws_verifiedaccess_endpoint`,
  ...
  `aws_wafv2_rule_group`, `aws_wafv2_web_acl`, `aws_wafv2_web_acl_rule`,
