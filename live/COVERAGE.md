...
| Admitted (the shipped table) | 931 types | Nothing at lint. Runtime support varies by type; see the layers below. |
...
931<!-- survey-gen:end contract-count --> types: <!-- survey-gen:begin contract-types -->
  ...
  `aws_apigatewayv2_vpc_link`, `aws_appautoscaling_policy`,
  ...
  `aws_appconfig_extension`, `aws_appflow_connector_profile`,
  ...
  `aws_dms_s3_endpoint`, `aws_docdb_cluster`, `aws_docdb_cluster_instance`,
  `aws_docdb_cluster_parameter_group`, `aws_docdb_event_subscription`,
  `aws_docdb_subnet_group`, `aws_docdbelastic_cluster`, `aws_dsql_cluster`,
  `aws_dx_connection`, `aws_dx_gateway`, `aws_dx_lag`,
  ...
  `aws_iam_account_alias`, `aws_iam_group`, `aws_iam_group_policy`,
  ...
  `aws_ivs_channel`, `aws_ivs_recording_configuration`,
  `aws_ivschat_logging_configuration`, `aws_ivschat_room`,
  `aws_kendra_data_source`, `aws_kendra_faq`, `aws_kendra_index`,
  ...
  `aws_m2_application`, `aws_m2_environment`, `aws_macie2_classification_job`,
  `aws_macie2_custom_data_identifier`, `aws_macie2_findings_filter`,
  `aws_macie2_member`, `aws_macie2_organization_admin_account`,
  `aws_mailmanager_ingress_point`, `aws_mailmanager_rule_set`,
  ...
  `aws_ram_permission`, `aws_ram_resource_share`, `aws_rbin_rule`,
  ...
  `aws_security_group_rule`, `aws_securityhub_account_v2`,
  `aws_securityhub_aggregator_v2`, `aws_securityhub_automation_rule`,
  ...
  `aws_sesv2_configuration_set`, `aws_sesv2_contact_list`,
  `aws_sesv2_dedicated_ip_pool`, `aws_sesv2_email_identity`,
  `aws_sesv2_tenant`, `aws_sfn_activity`, `aws_sfn_state_machine`,
  `aws_shield_protection`, `aws_shield_protection_group`,
  `aws_signer_signing_profile_permission`, `aws_sns_topic`,
  `aws_sns_topic_policy`, `aws_spot_fleet_request`, `aws_sqs_queue`,
