...
# overrides: doc example: cognito_identity_providers.client_id, cognito_identity_providers.provider_name, cognito_identity_providers.server_side_token_check
