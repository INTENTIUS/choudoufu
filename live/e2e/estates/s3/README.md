...
```
go run ./tools/estate-gen -cohort s3 -types aws_s3_bucket,aws_s3_bucket_lifecycle_configuration,aws_s3_bucket_policy,aws_s3_bucket_public_access_block,aws_s3_bucket_server_side_encryption_configuration,aws_s3_bucket_versioning -out /tmp/estate-gen/s3
