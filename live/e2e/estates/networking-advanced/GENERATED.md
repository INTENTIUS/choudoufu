...
| `aws_globalaccelerator_endpoint_group.app` | coverage | none |
...
| `aws_networkmanager_core_network.app` | coverage | none |
...
| `aws_networkmanager_device.app` | coverage | none |
...
| `aws_networkmanager_link_association.app` | coverage | none |
...
| `aws_networkmanager_site.app` | coverage | none |
