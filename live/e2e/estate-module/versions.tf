# ec2-module cohort — provider wiring, generated by tools/estate-gen
# -module-wrap (issue #59, 59b), plus one line no generated cohort carries:
# the "live" block. Every other estates/<cohort> fixture is lint/identity
...
# agree or the run would stamp one estate while planning against another.

terraform {
  required_version = ">= 1.5.0"

  live {
    estate = "ec2-module-cohort"
  }
