...
![How a plan binds a configuration address to a live resource](../site/assets/diagram-identity.svg)
...
reference](https://intentius.io/choudoufu/docs/use/compatibility/) still refuses, and it is
...
the [declaration-carried tier](https://intentius.io/choudoufu/docs/use/resource-tiers/)
names.

They are not a rounding error. On the same generated terralith [what a plan
costs](https://github.com/INTENTIUS/choudoufu/blob/main/live/costs/plan-cost.md#the-measured-split-on-a-migrated-estate)
...
[Where AWS honours the condition](https://intentius.io/choudoufu/docs/use/governance/reach/)
has that limit, and
