...
func main() {
	...
	modules, moduleUnknown := buildModuleQueue(s)
...
func buildPlan(s sweep) ([]estate, []string) {
	return buildQueue(s, ratePopulation)
}
...
func buildModuleQueue(s sweep) ([]estate, []string) {
	return buildQueue(s, modulePopulation)
}
...
func buildQueue(s sweep, origin string) ([]estate, []string) {
	var out []estate
