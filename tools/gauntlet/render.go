...
func Render(root string, m *Manifest, a *Artifact, tt TypeIndexTotals) ([]string, error) {
	var written []string
...
func renderProgressIndex(a *Artifact) string {
	...
	w("%s", boardBanner(a))
	w("")
	w("The behaviors-proven line above counts how many of the 14 stages below have")
	w("a FAST tier-1 fixture (`live/behaviors.json`) - a small, purpose-built script")
	w("that runs in minutes rather than an estate's own hours - whose representative")
	...
	w("have a fast signal for contributors.")
	w("")
	w("## The stages")
	w("")
