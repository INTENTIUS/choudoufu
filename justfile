...
ci:
    ...
    go build ./cmd/choudoufu
    echo "==> fast test tier"
    env -u PWD go test ./internal/live/... ./tools/... ./live/ ./cmd/... ./internal/command/ ./internal/engine/applying/ ./internal/tofu/...
...
# (4722).
demo-corpus-autoscaling-complete:
