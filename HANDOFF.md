...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1680 rendered identities across 577 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
