...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1685 rendered identities across 583 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
