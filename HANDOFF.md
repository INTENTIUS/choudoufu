...
1572 rendered identities across 507 configuration directories in under a
...
- `corpus-autoscaling-complete` - `lex00/floci#84` (`PutWarmPool`) is fixed and merged; the estate itself still needs a real re-cross to confirm migrate's tag-read-back against the current pin.
