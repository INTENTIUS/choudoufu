...
| Guard | What it holds |
|---|---|
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1714 rendered identities across 615 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
