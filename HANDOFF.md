...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1614 rendered identities across 550 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
