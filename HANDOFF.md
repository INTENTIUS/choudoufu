...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1623 rendered identities across 558 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
