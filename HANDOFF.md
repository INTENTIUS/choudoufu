...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1674 rendered identities across 574 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
