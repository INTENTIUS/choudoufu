...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1651 rendered identities across 567 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
