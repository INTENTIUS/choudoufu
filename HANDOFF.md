...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1628 rendered identities across 559 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
