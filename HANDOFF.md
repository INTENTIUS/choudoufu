...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1684 rendered identities across 580 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
