...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1592 rendered identities across 524 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
