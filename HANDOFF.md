...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1691 rendered identities across 588 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
