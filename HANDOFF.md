...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1618 rendered identities across 551 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
