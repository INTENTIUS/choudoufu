...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1601 rendered identities across 530 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
