...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1699 rendered identities across 599 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
