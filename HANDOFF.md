...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1617 rendered identities across 554 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
