...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1689 rendered identities across 587 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
