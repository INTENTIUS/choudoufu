...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1593 rendered identities across 529 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
