...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1629 rendered identities across 560 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
