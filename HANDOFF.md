...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1660 rendered identities across 571 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
