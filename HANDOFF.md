...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1648 rendered identities across 563 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
