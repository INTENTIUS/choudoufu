...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1632 rendered identities across 564 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
