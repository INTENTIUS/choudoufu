...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1672 rendered identities across 573 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
