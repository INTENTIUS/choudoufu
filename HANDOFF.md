...
| `internal/live/check`: `TestIdentityGolden`, `TestIdentityGoldenShapeIsPinned` | 1695 rendered identities across 590 configuration directories, pinned by value; if your change moves a line, explain it, and `-update` alone cannot silence it |
