...
# distinguishes this directory from stateless/e2e/estate: the "live"
...
terraform {
  ...
  # deliberately NOT "stateless-e2e" (the main estate's name, stateless/e2e/
...
provider "aws" {
  ...
  # main estate's versions.tf (stateless/e2e/estate/versions.tf): letting the
