...
import (
	...
	"github.com/intentius/choudoufu/internal/command/system"
	...
	pluginDiscovery "github.com/intentius/choudoufu/internal/plugin/discovery"
)
...
func initCommands(
	...
	// The command list is included in the choudoufu -help
